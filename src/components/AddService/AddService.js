...
const AddService = () => {
  ...
  const handleSubmit = (e) => {
    ...
    fetch("https://fast-gorge-50252.herokuapp.com/offers", {
      method: "POST",
      headers: {
        ...
        <div className="container-login100 align-items-start py-0">
          <div className="wrap-login100">
            ...
            >
              ...
              {/* Input Details Image  */}
              <div className="wrap-input100 validate-input">
                <span className="label-input100 p-0">Second Image Url</span>
                <input
                  required
                  ref={detailsImageRef}
                  className="input100 book-input"
              ...
              {/* Input Details */}
              <div className="wrap-input100 validate-input">
                <span className="label-input100 p-0">Details</span>
                <textarea
                  required
                  ref={detailsRef}
              ...
              <div className="d-flex align-items-end">
                <div className="wrap-input100 validate-input">
                  <span className="label-input100 p-0">Duration</span>
                  <input
                    required
                    ref={daysRef}
                    className="input100 book-input book-address"
